...
|---|---|
| `iachat read --de você --tudo` | o histórico inteiro: **7.476 tokens** na sala de 17/08, **66.649** com a sala no teto de 200 KB (medido, sala sintética de 159 msgs) |
| `iachat read --de você` (padrão) | **nada** — o filtro é por nominação e ninguém nomina quem acabou de chegar |
...
**2.210 B** na sala de 18/08 (19 mensagens, `DECISOES.md` inexistente) — teto duro de
4.096 B, provado com a sala no teto e 6 IAs. O briefing **não queima o seu cursor**:
ele não chama `ler()`, então `#n` antes = `#n` depois.
